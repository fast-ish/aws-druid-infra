...
This document describes the Kubernetes addons deployed with aws-druid-infra.
...
DruidNestedStack (depends on CoreAddonsNestedStack)
    │
...
# Check Druid logs
kubectl logs -n druid -l app=druid
